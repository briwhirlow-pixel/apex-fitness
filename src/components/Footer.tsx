      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 py-16 sm:py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-14">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <span className="text-white font-black text-[17px] tracking-tight">APEX</span>
            </div>
            <p className="text-white/35 text-[13px] leading-relaxed mb-6 max-w-[220px]">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['HIIT Forge', 'Iron Temple', 'Flow State', 'Velocity Cycle', 'Combat Ready', 'Recover & Reset'].map((cls) => (
                <li key={cls}>
                  <a href="/classes" className="text-white/50 text-[13px] hover:text-white transition-colors">{cls}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="text-white/50 text-[13px] hover:text-white transition-colors">{link.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-white/25 text-[11px] uppercase tracking-widest mb-1 font-semibold">Hours</p>
                <p className="text-white/50 text-[13px]">Mon–Fri: 5:30am – 9pm</p>
              ...
              <a href="/contact"
                className="inline-flex items-center gap-2 text-[#C8FF00] text-[13px] font-bold hover:gap-3 transition-all">
                Book a Free Class →
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-white/[0.06] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/20 text-[12px]">
            © {currentYear} APEX Performance Studio. All rights reserved.
          </p>
          <div className="flex gap-6">
            {['Privacy Policy', 'Terms of Service', 'Waiver'].map((item) => (
